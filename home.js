...
//CODE HERE
/**
 * i asked gpt to help me find a good syntax for this one. it gave me includes
 * i looked up .includes in MDN and it helped explain how it is used in more detail:
 * include(searchelement) basically it will give a true or false depending on the element found in the search array.
 * what this does is takes the array "deliveryareazipcodes" and runs through the array
 * as long as it finds the zip code it will give us a true, if it doesnt
 * it will return a false. 
 * which is why we have an if-else statement
 */
...
//deals.title = deals.title('15% off!','10% off!');
//onsole.log()
